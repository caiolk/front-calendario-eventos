...
import { TextField, Button, CircularProgress, Switch, Autocomplete, Paper } from '@mui/material';
...
const EventoDetalheIsolado = (eventoDetalhes: IDetalhesParam, tipo?:string) => {
  ...
  return (
    <div style={{width : '100%', height: '32vh', display:'flex', flexDirection: 'column', background: '#fff', padding: '20px', borderRadius: '5px'}}>
      <div className={classes.divRow} style={{ background: '#fff'}}>
        <TextField 
      ...
      <div className={classes.info} style={{ flexDirection: 'column',  justifyContent:'center', alignItems:'center',  width: '100%', marginTop: '2%' }} >
          <div>Inscrições</div>
      </div>

      <Paper className={ temInscricao ? classes.divRowEnd : classes.divRowMiddle } style={{ 'height': '45vh', background: '#fff', padding: '20px'}} >
...
export default EventoDetalheIsolado;